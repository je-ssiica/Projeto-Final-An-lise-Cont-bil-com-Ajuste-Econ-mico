...
plt.plot(df_grouped['Ano'], df_grouped['Margem Líquida'], marker='o', label='Margem Líquida (%)')
...
plt.figure(figsize=(10,6))
plt.plot(df_combined['Ano'], df_combined['Receita Líquida'], marker='o', label='Receita Líquida')
